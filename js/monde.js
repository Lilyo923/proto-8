...
const NIVEAUX = {};
const ORDRE_NIVEAUX = ['intro', 'niveau1'];   // l'ordre de progression du jeu
...
function chargerNiveau(id) {
  ...
  SAS = d.sas
    ? { x: d.sas.x * TUILE, y: d.sas.y * TUILE,
        w: (d.sas.w || 3) * TUILE, h: (d.sas.h || 6) * TUILE,
        style: d.sas.style || 'sas' }
    : null;
